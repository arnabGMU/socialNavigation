...
from gibson2.challenge.test_SAC_evaluate import Challenge
...
def main():
    ...
    parser.add_argument('--checkpoint_name', type=str, default="deterministic_polar_potential0.1_orientation0.01_threshold0.1_final_fixed_2")
    ...
    parser.add_argument('--checkpoint_name_memory', type=str, default="deterministic_polar_potential0.1_orientation0.01_threshold0.1_final_fixed_memory")
