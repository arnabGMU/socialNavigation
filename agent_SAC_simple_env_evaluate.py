...
def main():
    ...
    parser.add_argument('--checkpoint_path', type=str, default="checkpoints/sac_checkpoint_simpleenv_deterministic_potential0.1orientation0.01")
    parser.add_argument('--checkpoint_name', type=str, default="simpleenv_deterministic_potential0.1orientation0.01")

    parser.add_argument('--load_checkpoint_memory', type=bool, default=True)
    parser.add_argument('--checkpoint_path_memory', type=str, default="checkpoints/sac_buffer_simpleenv_deterministic_potential0.1orientation0.01_memory")
    parser.add_argument('--checkpoint_name_memory', type=str, default="simpleenv_deterministic_potential0.1orientation0.01_memory")
