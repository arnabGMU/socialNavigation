...
def main():
    ...
    parser.add_argument('--replay_buffer_type', type=str, default='not_prioritized')
    ...
    parser.add_argument('--checkpoint_path', type=str, default="checkpoints/sac_checkpoint_goal20_pedestrianCollision20_greedyEpsilon0.2_mapCNN_withoutPedestrian_fullTraining_collision-20_lidar")
    parser.add_argument('--checkpoint_name', type=str, default="goal20_pedestrianCollision20_greedyEpsilon0.2_mapCNN_withoutPedestrian_fullTraining_collision-20_lidar")
    ...
    parser.add_argument('--map', type=str, default='lidar')
